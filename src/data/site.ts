...
export const seoLandingPages = [
	{ label: fillBrandTokens('{game} hacks'), href: '/valorant-cheats/' },
	{ label: fillBrandTokens('{primaryKeyword}'), href: '/valorant-cheats/' },
	...
	{ label: fillBrandTokens('Undetected {primaryKeyword}'), href: '/valorant-cheats/' },
...
export const footerExplore = [
	...
	{ label: fillBrandTokens('{game} hacks pillar'), href: '/valorant-cheats/' },
...
export const homeFaqs: readonly FaqItem[] = [
	...
	faq({
		question: 'Does this work in Unrated and Competitive?',
		answer:
			'Yes. ESP, radar, and aimbot are built for {game} round flow — reading agents, spotting spike and orbs, and staying aware near sites.',
		slug: 'unrated-and-competitive',
		seoTitle: 'Unrated and Competitive Support | FAQ',
		seoDescription:
			'{brand} works in Unrated and Competitive — ESP, radar, and aimbot for Windows PC.',
	}),
	faq({
		question: 'What is included — ESP, wallhack, radar, or Aimbot?',
		answer:
			'{brand} bundles ESP wallhack, orb markers, 2D radar cues, and configurable Aimbot in one license. See Features for the full list.',
		slug: 'esp-wallhack-radar-or-aimbot',
		seoTitle: 'What Is Included: ESP, Wallhack, Radar, Aimbot | FAQ',
		seoDescription:
			'One {brand} license includes ESP wallhack, orb markers, 2D radar cues, and configurable Aimbot for Windows PC.',
	}),
	faq({
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'A {game} wallhack is an ESP overlay that shows agents, enemies, and spike through walls. {brand} includes distance readouts, site cues, and toggleable categories.',
		slug: 'what-is-a-valorant-wallhack',
		seoTitle: 'What Is a {game} Wallhack? | FAQ',
		seoDescription:
			'A {game} wallhack is ESP that reveals agents, enemies, and spike through walls — with distance, sites, and category toggles.',
	}),
	faq({
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_VAL',
		rating: 5,
		text: 'Soft aim in Valorant Cheats feels smooth on Ascent. The menu took a few minutes to learn. After that, matches felt easy.',
		short: 'Soft aim in Valorant Cheats feels smooth on Ascent.',
		slug: 'valorant-soft-aim-review-xkrypt0',
		seoTitle: 'Soft Aim Review by @xKrypt0_VAL — 5/5 | {brand}',
		seoDescription: '@xKrypt0_VAL rates {brand} soft aim 5/5 for Ascent on Windows PC.',
		date: '2026-07-24',
		tag: 'Soft aim',
	}),
	reviewMeta({
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Valorant Cheats this episode. Setup was simple. It stayed up after the last Vanguard update when my old cheat failed. Lifetime was a good buy.',
		short: 'Valorant Cheats stayed up after the last Vanguard update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Valorant Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Valorant Cheats is easy to tune on PC.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Valorant Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Breeze is solid.',
		short: 'ESP on Breeze is solid. Support helped after a slow first launch.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Orb ESP in Valorant Cheats pays for the monthly plan. Spike markers and distance make early rounds faster.',
		short: 'Orb ESP in Valorant Cheats pays for the monthly plan.',
		slug: 'valorant-loot-esp-review-lootgoblinx',
		seoTitle: 'Orb ESP Review by @lootGoblinx — 5/5 | {brand}',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Valorant Cheats since last episode. Soft aim per weapon helps in Haven. Status updates after Vanguard patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Valorant Cheats helps in Haven.',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Valorant Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Valorant Cheats was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Operator soft aim plus ESP in Valorant Cheats is excellent for long shots. Simple and strong.',
		short: 'Operator soft aim plus ESP in Valorant Cheats is excellent.',
