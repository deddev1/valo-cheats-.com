# Valorant Cheats — Marketing Site

Static Astro 7 site for [valocheats.com](https://valocheats.com). Primary SEO keyword: **valorant cheats** (secondary: valorant hacks, aimbot, ESP).
...
1. Create a Cloudflare Pages project named **valo-cheats--com**
2. Connect this repo or upload `dist/` after `npm run build`
3. Build command: `npm run build`
4. Output directory: `dist`
5. Add custom domain **valocheats.com** (apex) and redirect **www** → apex
...
Private — for valocheats.com deployment only.
