...
export const phrases = {
	es: {
		buy: 'Comprar Valorant Cheats', undetected: 'indetectables', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'Contacta support@valocheats.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Valorant Cheats', undetected: 'indétectables', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'Contactez support@valocheats.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Valorant Cheats kaufen', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Valorant Cheats', undetected: 'indetectáveis', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'Contacte support@valocheats.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Valorant Cheats', undetected: 'indetectable', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'Contatta support@valocheats.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Valorant Cheats kopen', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Valorant Cheats satın al', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'Destek ve yasal sorular için support@valocheats.com.',
	},
	ar: {
		buy: 'اشترِ Valorant Cheats', undetected: 'غير مكتشف', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Valorant Cheatsを購入', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'サポート・法務: support@valocheats.com',
	},
	ko: {
		buy: 'Valorant Cheats 구매', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => '지원 및 법무: support@valocheats.com',
	},
	zh: {
		buy: '购买 Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => '支持与法务：support@valocheats.com',
	},
	hi: {
		buy: 'Valorant Cheats खरीदें', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'सहायता: support@valocheats.com',
	},
	id: {
		buy: 'Beli Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Valorant Cheats', undetected: 'undetected', maps: 'Ascent, Bind, and Haven',
		...
		legal: () => 'support@valocheats.com för support och juridik.',
	},
};
