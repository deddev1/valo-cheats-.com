...
export function readBrandForStudio() {
	...
	const keywords = listMatch
		...
		: [];
	const seoBlock = siteBlock(src, 'seo');
	const copyBlock = siteBlock(src, 'copy');
	const sitemapBlock = siteBlock(src, 'sitemap');
	const themeBlock = siteBlock(src, 'theme');
	/** @type {Record<string, string>} */
	const seo = {};
